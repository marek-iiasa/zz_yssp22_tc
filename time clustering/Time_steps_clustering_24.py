...
def algorithm(data,regions,solarweight,windweight,hydroweight,demandweight,mid_night,path): 
    ...
    while region < total_regions:
        ...
        while s_w_h_d < 4:
            ...
            plt.savefig(path+'Results/24 Time slices '+ regions[region]+' seasonal '+s_w_h_ds[s_w_h_d])            
    ...
    while region < total_regions:
        ...
        plt.savefig(path+'Results/24 Time slices '+ regions[region]+' annual '+s_w_h_ds[s_w_h_d])        
