...
os.chdir(path_dir.split("\\TimeClustering")[0])
...
# If you want the timeslices to start at 00:00 GTM for all reagions gtm = True. For aleatory start time gtm = False
...
if op == 1:
    ...
    t12(
        input_data,
        regions_or_countries,
        selected_regions_or_countries,
        solar_weight,
        wind_weight,
        hydro_weight,
        demand_weight,
