...
path = "D:/Message_project/zz_yssp22_tc/time clustering/"
...
if daily_time_slices_in_a_week == 2:
    ...
    path_results = path+'Results1/'+yearly_divisions_type+'_ts='+str(yearly_divisions)+' hourly_ts='+str(hourly_time_slices_in_a_day)+'/'
