...
if __name__  == ' __main__':
    ...
    model = 'test-time'
    scen_ref = 'three-technology'
    version_ref = 4
        
    filename = 'GM_11R_water_scheme_simple.xlsx'  # Name of the input Excel file
    ...
    start = timer()
    sc = sc_ref.clone(model, scen_ref + '_water', keep_solution=False)
