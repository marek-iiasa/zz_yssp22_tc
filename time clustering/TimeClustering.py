...
if op==1:
    ...
    t12(input_data,regions_or_countries,selected_regions_or_countries,solar_weight,wind_weight,hydro_weight,demand_weight,mid_night,path_dir)
    x = 0

elif op==2:
    from Time_steps_clustering_24 import algorithm as t24
    t24(input_data,regions_or_countries,selected_regions_or_countries,solar_weight,wind_weight,hydro_weight,demand_weight,mid_night,path_dir)
    x = 0

elif op==3:
    from Time_steps_clustering_48 import algorithm as t48
    t48(input_data,regions_or_countries,selected_regions_or_countries,solar_weight,wind_weight,hydro_weight,demand_weight,mid_night,path_dir)
    x = 0
