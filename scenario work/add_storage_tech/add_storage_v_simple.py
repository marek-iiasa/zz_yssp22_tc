...
path_files = (r'H:/Things in C Drive/IIASA/Energy Group/MESSAGE' +
              r'/Hydropower storage representation')
os.chdir(path_files)
...
if __name__  == ' __main__':
    ...
    model = 'test-time'
    scen_ref = 'three-technology_water'
    version_ref = 16
    
    # File name for the Excel file of input data
    filename = 'GM_11R_add_storage_simple.xlsx'
    ...
    tec_list = ["river_dist", "river", "water_distribution", "dam_hydro", 
                "spillway_hydro", "pump_sphs", "dam_sphs", "turb_sphs","hydro_dam"]
    ...
    tec_list = ["river_dist", "river", "water_distribution", "dam_hydro", 
                "spillway_hydro", "pump_sphs", "dam_sphs", "turb_sphs"]
    ...
    tecs = ["hydro_dam", "hydro_lc","hydro_hc","wind_cv1","solar_i","solar_rc","turb_sphs"]
